...
describe('ServicesList Tests', () => {
    test('ServicesList should populate the page with png image(s)', async () => {
        ...
        images = screen.getAllByTestId('serviceImg');
    ...
    test('If png is not available for a service, text will be used in place of a logo', async () => {
        const mockAxiosMoviesList = {
            data: [
                    {
                        "type": "movie",
